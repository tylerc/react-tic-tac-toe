...
function respondWithGameState(res: http.ServerResponse, gameState: GameState) {
    ...
    res.end(ReactDOMServer.renderToStaticMarkup(
        ...
        <head>
            ...
            <script type="text/javascript" src="/turbolinks.js" />
...
const server = http.createServer(async (req, res) => {
    ...
    } else if (urlParsed.pathname === "/turbolinks.js") {
        res.writeHead(200, { "Content-Type": "text/javascript" });
        res.end(fs.readFileSync(path.join(__dirname, "../node_modules/turbolinks/dist/turbolinks.js")));
    } else {
